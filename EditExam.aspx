...
<head runat="server">
    ...
    <title>ST MARY'S LMS EDIT EXAM</title>
...
<body style="background-size: ">
    ...
    <form id="form2" runat="server">
        <nav class="Lnavbar">
            ...
            <!-- <li class="Lnav-item">
                ...
                <li class="Lnav-item">
                    <a href="Exam.aspx" class="Lnav-link Lnav-link-current">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><a href="Exam.aspx"><b>Exam</b></a> <span class="bread-slash">/</span>
                                                </li>
                                                <li><span class="bread-blod">Edit Exam</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="margin-top: 5px;">
                        <div class="sparkline10-list mg-b-20" style="box-shadow: 2px 2px 28px #8888889e; border-radius: 5px; height: 40vh">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Exam ID</label>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Exam Type</label>
                                        <asp:DropDownList runat="server" ID="EType" CssClass="form-control basic-ele-mg-t-10"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ...
                                            ControlToValidate="EType"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Start Datetime</label>
                                        <asp:TextBox runat="server" ID="StartDate" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>  
                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-3 " style="margin-top:25px">
                                        <asp:TextBox runat="server" ID="StartTime" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ...
                                            ControlToValidate="StartTime"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group-inner formInnerGroupRowBtn">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <asp:Button runat="server" ID="EditE" class="btn btn-default btn-lg" Text="Edit Exam"
                                        OnClick="EditE_Click" ValidationGroup="Submit" type="submit" Style="outline: none; background-color: #5A6268; color: white" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            $('#StartTime').timepicker({ 'timeFormat': 'H:i:s', 'step': 0.5 });
        });
    </script>
</body>
</html>